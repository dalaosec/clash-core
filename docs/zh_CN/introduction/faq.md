...
这里是一些大家遇到的常见问题. 如果您有任何此处未列出的问题, 请随时[提交一个 issue](https://github.com/dalaosec/clash-core/issues/new/choose).
...
- 华硕RT-AC5300: armv5 [#2356](https://github.com/dalaosec/clash-core/issues/2356)
- 联发科MT7620A, MT7621A: mipsle-softfloat ([#136](https://github.com/dalaosec/clash-core/issues/136))
...
请参考这个讨论: [#422](https://github.com/dalaosec/clash-core/issues/422)
...
您正在使用 Clash 开源版. 规则 Providers 目前仅在 [免费 Premium 内核](https://github.com/dalaosec/clash-core/releases/tag/premium) 中可用.
