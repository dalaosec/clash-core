...
- [Clash](https://github.com/dalaosec/clash-core): 发布于[github.com/dalaosec/clash-core](https://github.com/dalaosec/clash-core)的开源版本
- [Clash Premium 版本](https://github.com/dalaosec/clash-core/releases/tag/premium): 具有[TUN 和更多支持](/zh_CN/premium/introduction) 的专有内核 (免费)
...
Clash 是根据 [GPL-3.0](https://github.com/dalaosec/clash-core/blob/master/LICENSE) 开源许可证发布的. 在 [v0.16.0](https://github.com/dalaosec/clash-core/releases/tag/v0.16.0) 或 [e5284c](https://github.com/dalaosec/clash-core/commit/e5284cf647717a8087a185d88d15a01096274bc2) 提交之前, 其基于 MIT 许可证授权.
