...
In the past, there was only one open-source version of Clash, until some [improper uses and redistributions](https://github.com/dalaosec/clash-core/issues/541#issuecomment-672029110) of Clash arose. From that, we decided to fork Clash and develop the more advanced features in a private GitHub repository.
...
You can download the latest Clash Premium binaries from [GitHub Releases](https://github.com/dalaosec/clash-core/releases/tag/premium).
