...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/dalaosec/clash-core/constant.Version=$(VERSION)" \
		-X "github.com/dalaosec/clash-core/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
